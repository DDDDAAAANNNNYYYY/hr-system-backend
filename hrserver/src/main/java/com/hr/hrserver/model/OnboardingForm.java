...
public class OnboardingForm {
    ...
    public File getDriverLicenseCopy() {
        return driverLicenseCopy;
    }

    public void setDriverLicenseCopy(File driverLicenseCopy) {
        this.driverLicenseCopy = driverLicenseCopy;
    }
    ...
    private File driverLicenseCopy;
